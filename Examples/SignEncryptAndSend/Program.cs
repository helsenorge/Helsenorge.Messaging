...
namespace SignEncryptAndSend
{
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            try
            {
                var signatureCertificate = TestCertificates.GenerateSelfSignedCertificate(System.Security.Cryptography.X509Certificates.X509KeyUsageFlags.NonRepudiation, DateTimeOffset.Now.AddDays(-1), DateTimeOffset.Now.AddMonths(1));
                var encryptionCertificate = TestCertificates.GenerateSelfSignedCertificate(System.Security.Cryptography.X509Certificates.X509KeyUsageFlags.KeyEncipherment, DateTimeOffset.Now.AddDays(-1), DateTimeOffset.Now.AddMonths(1)); ;
